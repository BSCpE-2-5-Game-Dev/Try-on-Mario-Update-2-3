...
function PlayState:init()
    self.camX = 0
    self.camY = 0
    self.level = LevelMaker.generate(30 + globalWidth, 10, self.extraWidth)
...
function PlayState:enter(params)
    if params then
        --print('Playstate width is: '..params.newWidth)
        self.player.score = params.score
        --print('generate new map with width = '..params.newWidth)
        --self.map = LevelMaker.generate(params.newWidth, 10)
